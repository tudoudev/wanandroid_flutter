...
ChaptersEntity $ChaptersEntityFromJson(Map<String, dynamic> json) {
  final ChaptersEntity chaptersEntity = ChaptersEntity();
  final List<dynamic>? articleList = (json['articleList'] as List<dynamic>?)?.map(
          (e) => e).toList();
  if (articleList != null) {
    chaptersEntity.articleList = articleList;
  }
  final String? author = jsonConvert.convert<String>(json['author']);
  if (author != null) {
    chaptersEntity.author = author;
  }
  final List<ChaptersEntity>? children = (json['children'] as List<dynamic>?)?.map(
          (e) => jsonConvert.convert<ChaptersEntity>(e) as ChaptersEntity).toList();
  if (children != null) {
    chaptersEntity.children = children;
  }
  final int? courseId = jsonConvert.convert<int>(json['courseId']);
  if (courseId != null) {
    chaptersEntity.courseId = courseId;
  }
  final String? cover = jsonConvert.convert<String>(json['cover']);
  if (cover != null) {
    chaptersEntity.cover = cover;
  }
  final String? desc = jsonConvert.convert<String>(json['desc']);
  if (desc != null) {
    chaptersEntity.desc = desc;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    chaptersEntity.id = id;
  }
  final String? lisense = jsonConvert.convert<String>(json['lisense']);
  if (lisense != null) {
    chaptersEntity.lisense = lisense;
  }
  final String? lisenseLink = jsonConvert.convert<String>(json['lisenseLink']);
  if (lisenseLink != null) {
    chaptersEntity.lisenseLink = lisenseLink;
  }
  final String? name = jsonConvert.convert<String>(json['name']);
  if (name != null) {
    chaptersEntity.name = name;
  }
  final int? order = jsonConvert.convert<int>(json['order']);
  if (order != null) {
    chaptersEntity.order = order;
  }
  final int? parentChapterId = jsonConvert.convert<int>(json['parentChapterId']);
  if (parentChapterId != null) {
    chaptersEntity.parentChapterId = parentChapterId;
  }
  final int? type = jsonConvert.convert<int>(json['type']);
  if (type != null) {
    chaptersEntity.type = type;
  }
  final bool? userControlSetTop = jsonConvert.convert<bool>(json['userControlSetTop']);
  if (userControlSetTop != null) {
    chaptersEntity.userControlSetTop = userControlSetTop;
  }
  final int? visible = jsonConvert.convert<int>(json['visible']);
  if (visible != null) {
    chaptersEntity.visible = visible;
  }
...
extension ChaptersEntityExtension on ChaptersEntity {
  ChaptersEntity copyWith({
    List<dynamic>? articleList,
    String? author,
    List<ChaptersEntity>? children,
    int? courseId,
    String? cover,
    String? desc,
    int? id,
