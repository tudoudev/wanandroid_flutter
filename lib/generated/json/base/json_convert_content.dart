...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<ArticleTags>[] is M) {
      return data.map<ArticleTags>((Map<String, dynamic> e) => ArticleTags.fromJson(e)).toList() as M;
    }
    ...
    if (<ChaptersEntity>[] is M) {
      return data.map<ChaptersEntity>((Map<String, dynamic> e) => ChaptersEntity.fromJson(e)).toList() as M;
    }
