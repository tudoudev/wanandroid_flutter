...
class _MainService implements MainService {
  ...
  @override
  Future<BaseEntity<PagingEntity<IntegrateEntity>>> lgCoinList(
      int pageNum) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseEntity<PagingEntity<IntegrateEntity>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value =
        BaseEntity<PagingEntity<IntegrateEntity>>.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<BaseEntity<UserInfoEntity>> login(FormData map) async {
    ...
    final _value = BaseEntity<UserInfoEntity>.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<BaseEntity<dynamic>> register(FormData map) async {
    ...
    final _value = BaseEntity<dynamic>.fromJson(_result.data!);
    return _value;
  }

  @override
  Future<BaseEntity<dynamic>> collect(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseEntity<dynamic>> uncollect(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseEntity<PagingEntity<ArticleEntity>>> collectList(
      int pageNum) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
